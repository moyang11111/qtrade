"""
Test strategies on CSI 500 (中证500) components.
These are mid-cap stocks with better market representation.
...
def main():
    ...
    results_df.to_csv(f"{out_dir}/csi500_regime_split_results.csv", index=False)
